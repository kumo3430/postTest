...
// $sql = "INSERT INTO `routine` (`uid`,`set_up_time`, `_classification`, `_sub_classification`, `task_name`, `tag_id1`, `tag_id2`,`target_quantity`,`target_time`, `fulfill`, `note`, `alert_time`, `show_to_club`, `completion`) VALUES ('$uid','$set_up_time', '$_classification' , '$_sub_classification', '$task_name', '$tag_id1', NULL, NULL, '$target_time', NULL , '$note', '$alert_time', NULL,NULL)";
...
//     $sql = "INSERT INTO `routine` (`uid`,`set_up_time`, `_classification`, `_sub_classification`, `task_name`, `tag_id1`, `tag_id2`, `target`,`target_quantity`,`target_time`, `fulfill`, `_cycle`, `note`, `alert_time`, `show_to_club`, `completion`) VALUES ('$uid','$set_up_time', '$_classification' , '$_sub_classification', '$task_name', '$tag_id1', NULL, '$target', '$target_quantity', NULL, NULL, '$_cycle' , '$note', '$alert_time', NULL,NULL)";
// } else {
//     $sql = "INSERT INTO `routine` (`uid`,`set_up_time`, `_classification`, `_sub_classification`, `task_name`, `tag_id1`, `tag_id2`, `target`,`target_quantity`,`target_time`, `fulfill`, `_cycle`, `note`, `alert_time`, `show_to_club`, `completion`) VALUES ('$uid','$set_up_time', '$_classification' , '$_sub_classification', '$task_name', '$tag_id1', NULL, NULL, NULL, '$target_time', NULL, '$_cycle' , '$note', '$alert_time', NULL,NULL)";
// }

// $sql = "INSERT INTO `routine` (`uid`,`set_up_time`, `_classification`, `_sub_classification`, `task_name`, `tag_id1`, `tag_id2`, `target`,`target_quantity`,`target_time`, `fulfill`, `_cycle`, `note`, `alert_time`, `show_to_club`, `completion`) VALUES ('$uid','$set_up_time', '$_classification' , '$_sub_classification', '$task_name', '$tag_id1', NULL, '$target', '$target_quantity', '$target_time', NULL, '$_cycle' , '$note', '$alert_time', NULL,NULL)";
